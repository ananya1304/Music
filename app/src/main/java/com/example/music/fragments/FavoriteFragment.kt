...
import com.example.music.adapters.FavoriteAdapter
import com.example.music.data.EchoDatabase
import com.example.music.data.Songs
import com.example.music.fragments.FavoriteFragment.Statified.meediaPlayer
...
class FavoriteFragment : Fragment() {
    ...
    fun display_favorites_by_searching() {
        if (favouriteDatabase?.checkSize() as Int > 0) {
            ...
            val _mainScreenAdapter = FavoriteAdapter(activity, refreshList as ArrayList<Songs>)
